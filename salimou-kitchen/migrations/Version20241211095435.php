 ...
 */
final class Version20241211095435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD category_id INT DEFAULT NULL, ADD category VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP category_id, DROP category');
    }
}
